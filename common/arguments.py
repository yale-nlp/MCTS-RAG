...
def get_parser():
    ...
    allowed_apis = ["together", "huggingface", "llama", "vllm", "debug", "gpt-4o"]
    parser.add_argument(
    ...
    parser.add_argument("--num_beams", type=int, default=3, help="num_beams")
    ...
    allowed_dataset_names = ["FMT", "GPQA","WICE", "CWEBQA", "MATH", "GSM8K", "GSM8KHARD", "STG", "SVAMP", "MULTIARITH", "ScienceQA", "SciKEval", "CFA"]
    parser.add_argument(
        "--dataset_name",
        required=True,
